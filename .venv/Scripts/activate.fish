...
set -gx VIRTUAL_ENV 'D:\vs\homeworks\project1_Shevchenko_Sergey\.venv'
...
if test -n project1-shevchenko-sergey-py3.12
    set -gx VIRTUAL_ENV_PROMPT project1-shevchenko-sergey-py3.12
else
